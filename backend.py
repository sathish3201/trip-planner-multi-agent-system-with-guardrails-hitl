...
# Enable nested event loops for sync functions inside FastAPI
nest_asyncio.apply()
...
# =========================
def run_async(coro):
    """Safely execute async coroutines from synchronous graph node functions."""
    try:
...
llm = ChatOllama(model="qwen2.5-coder:1.5b", base_url="http://localhost:11434")
